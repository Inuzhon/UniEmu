...
test('emulator tag table uses localized labels and adaptive static preview input', async () => {
  ...
  assert.match(tagsSource, /className="h-7 w-full min-w-0 max-w-\[18rem\] px-2 py-1 font-mono text-xs"/);
