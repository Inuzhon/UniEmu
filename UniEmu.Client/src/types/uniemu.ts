...
export const SPECIAL_PARAMETER_OPTIONS: { value: SpecialParameter; label: string }[] = [
  ...
  { value: 'PartCounter', label: 'Счетчик деталей' },
  { value: 'ErrorNum', label: 'Код ошибки' },
  { value: 'FeedOvr', label: 'Корректор подачи' },
  { value: 'SpindleOvr', label: 'Корректор шпинделя' },
  { value: 'JogOvr', label: 'Корректор JOG/Rapid' },
  { value: 'FrameNum', label: 'Номер кадра УП' },
  { value: 'FrameText', label: 'Текст кадра УП' },
  { value: 'ToolNum', label: 'Номер инструмента' },
  { value: 'WorkMode', label: 'Текущий режим' },
  { value: 'SystemState', label: 'Состояние режима' },
  { value: 'MachineReadiness', label: 'Готовность станка (УЧПУ)' },
  { value: 'TechnologicalStop', label: 'Технологический останов' },
  { value: 'EmergencyStop', label: 'Авария' },
  { value: 'FeedRate', label: 'Подача F' },
  { value: 'ErrorText', label: 'Текст ошибки' },
  { value: 'CycleTime', label: 'Время цикла' },
  { value: 'SpindleSpeed', label: 'Скорость шпинделя' },
  { value: 'SpindleLoad', label: 'Нагрузка шпинделя, %' },
  { value: 'AxisLoad', label: 'Ось. Нагрузка' },
  { value: 'AxisPosition', label: 'Ось. Координата' },
  { value: 'Message', label: 'Сообщение' },
  { value: 'CNCModel', label: 'Модель УЧПУ' },
  { value: 'FirmwareVersion', label: 'Версия прошивки' },
  { value: 'SerialNumber', label: 'Серийный номер' },
  { value: 'PLCVersion', label: 'Версия ПО ПЛК' },
